module.exports = class Data1676606614237 {
    name = 'Data1676606614237'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "token" ("id" character varying NOT NULL, "owner_id" character varying, CONSTRAINT "PK_82fae97f905930df5d62a702fc9" PRIMARY KEY ("id"))`)
